...
func (i Series) Read(ctx context.Context, params series.Params) (series.Set, error) {
	tlsConfig := config_util.TLSConfig{
		CAFile:             i.conf.HTTPConfig.TLSConfig.CAFile,
		CertFile:           i.conf.HTTPConfig.TLSConfig.CertFile,
		KeyFile:            i.conf.HTTPConfig.TLSConfig.KeyFile,
		ServerName:         i.conf.HTTPConfig.TLSConfig.ServerName,
		InsecureSkipVerify: i.conf.HTTPConfig.TLSConfig.InsecureSkipVerify,
	}

	httpConfig := config_util.HTTPClientConfig{
		TLSConfig: tlsConfig,
		BearerToken: i.conf.HTTPConfig.BearerToken,
	}
